...
This project was developed by Felipe Brito and Vinicius Mata e Mota for the Computer Vision course (Reconnaissance Visuelle).
...
```
This will process `lena_color.tiff` and display the result.
...
```
This script will:
1. Look for BSDS500 dataset or use local images (like `lena_color.tiff`).
